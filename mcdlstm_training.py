            ...
            for res in resources:
                for h in hs:
                    for c in clusters:
                        ...
                        if tuning:
                            experiment_name = 'tuned-MCDLSTM-' + res + '-' + c + '-w' + str(win) + '-h' + str(h) + \
                        ...
                        ds = dataset.Dataset(data_path='saved_data/cg19/', meta=False, filename='res_task_' + c + '.csv', winSize=win, horizon=h,
